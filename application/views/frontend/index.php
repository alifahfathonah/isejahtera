...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/css/navmenu/styles.css"; ?>">
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/css/portfolio.jquery.css"; ?>">
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/css/fonticons.css"; ?>">
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/style.css"; ?>">
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/fonts/stylesheet.css"; ?>">
        ...
        <link rel="stylesheet" href="<?php echo base_url()."assets/front/assets/css/plugins.css"; ?>" />
        ...
        <script src="<?php echo base_url()."assets/front/assets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"; ?>"></script>
    </head>
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <script src="<?php echo base_url()."assets/front/assets/js/vendor/jquery-1.11.2.min.js"; ?>"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/vendor/bootstrap.min.js"; ?>"></script>

        <script src="<?php echo base_url()."assets/front/assets/js/jquery.easypiechart.min.js"; ?>"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/portfolio.jquery.js"; ?>"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/jquery.mixitup.min.js"; ?>"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/jquery.easing.1.3.js"; ?>"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/jquery.slicknav.min.js"; ?>"></script>
        <!--This is link only for gmaps-->
        <script src="http://maps.google.com/maps/api/js"></script>
        <script src="<?php echo base_url()."assets/front/assets/js/gmaps.min.js"; ?>"></script>
        <script>
            var map = new GMaps({
                el: '.ourmaps',
                scrollwheel: false,
